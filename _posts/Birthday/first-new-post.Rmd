...
From this point, the previous steps are applied for as many number of people are present to calculate the probability of Not Sharing a Birthday.  In order to find the probability of Sharing the same birthday will require one simple addition.  
