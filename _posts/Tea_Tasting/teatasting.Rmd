...
The following graph helps us visualize what that this math looks like.  It is done by drawing out a Binomial Distribution and then highlighting the areas we are intesesting in solving.  The equation to this math is:
...
And lastly, we have if she were to identify all 8 cups correctly, her value would be 0.003906, which is < 0.05.  With this value, we can say we evidence to suggest that the lady can indeed taste the difference between teh two types of tea.
